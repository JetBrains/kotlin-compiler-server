...
fun generateProperties(prefix: String = "", enableStreamingController: Boolean = true) = """
    ...
    enable.streaming.controller=${enableStreamingController}
""".trimIndent()
...
val buildLambda by tasks.creating(Zip::class) {
    ...
    from(tasks.processResources) {
        eachFile {
            if (name == propertyFile) { file.writeText(generateProperties(lambdaWorkDirectoryPath, false)) }
        }
    }
    from(policy)
