...
class CoroutinesRunnerTest : BaseExecutorTest() {
  ...
  fun `base coroutines test 13`() {
    ...
    Assertions.assertTrue(result.getException()?.message == expectedExMessage,
      "Actual: ${result.getException()?.message}. Expected: $expectedExMessage")
    Assertions.assertTrue(result.getException()?.fullName == expectedEx, "Actual: ${result.getException()?.fullName}. Expected: $expectedEx")
  }
