...
abstract class AbstractConvertToJsRunnerTest : BaseExecutorTest() {
  abstract val useIrCompiler: Boolean
...
class ConvertToJsRunnerTest : AbstractConvertToJsRunnerTest() {
  override val useIrCompiler: Boolean = false
...
class ConvertToJsIrRunnerTest : AbstractConvertToJsRunnerTest() {
  override val useIrCompiler: Boolean = true
}